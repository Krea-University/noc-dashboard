...
export const DisplayPage: React.FC = () => {
  ...
  if (isIdle) {
    return (
      <div className="h-screen w-screen bg-black flex flex-col items-center justify-center p-8 select-none">
        <div className="text-center space-y-4">
          <div className="text-slate-600 font-extrabold uppercase tracking-widest text-lg">
            KREA IT NOC — DISPLAY IDLE
          </div>
          <div className="font-mono text-8xl font-black text-slate-400 tracking-wider">
            {timeStr}
          </div>
          <div className="flex items-center justify-center gap-3 text-emerald-400 font-bold text-xl pt-2">
  ...
  return (
    <div className="h-screen w-screen bg-[#06090e] text-slate-100 flex flex-col overflow-hidden select-none font-sans">
      {/* Recovery Banner */}
      {recoveryBanner && (
        <div className="bg-emerald-600 text-white px-8 py-3 flex items-center justify-between shadow-2xl z-40 animate-in slide-in-from-top duration-300">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-sm ml-4 font-mono font-semibold">
                Downtime Duration: {recoveryBanner.downtimeString}
              </span>
            </div>
          </div>
          <span className="text-xs font-mono uppercase bg-emerald-700 px-3 py-1 rounded">
            Recovery Recorded
          </span>
        </div>
      )}
      ...
      {criticalTakeover && (
        <div className="fixed inset-0 z-50 bg-red-950/95 border-8 border-red-600 flex flex-col justify-between p-12 animate-pulse">
          <div className="flex items-center justify-between border-b border-red-500/50 pb-6">
            <div className="flex items-center gap-4">
              <AlertTriangle className="w-14 h-14 text-red-400 animate-bounce" />
              <div>
                <h1 className="text-4xl font-black text-white tracking-wider uppercase">
                  CRITICAL OUTAGE DETECTED
                </h1>
                <p className="text-red-300 text-lg mt-1 font-mono">
                  Immediate NOC Intervention Required • Escalation Level 1 Active
                </p>
              </div>
            </div>
            <div className="text-right font-mono">
              <div className="text-red-400 text-sm font-bold uppercase">Incident Detected</div>
              <div className="text-white text-2xl font-bold">{criticalTakeover.detectedAt}</div>
            </div>
          </div>

          <div className="my-auto space-y-6">
            <div className="bg-black/60 p-8 rounded-2xl border border-red-500/40">
              <div className="text-sm font-bold text-red-400 uppercase tracking-widest mb-2 font-mono">
                Primary Root Device
              </div>
              <div className="text-5xl font-black text-white font-mono">{criticalTakeover.deviceName}</div>
              <div className="text-xl text-red-200 mt-2 font-medium">
                Location: {criticalTakeover.location}
              </div>
            </div>

            <div className="grid grid-cols-2 gap-6">
              <div className="bg-black/60 p-6 rounded-2xl border border-red-500/40">
              ...
              <div className="bg-black/60 p-6 rounded-2xl border border-red-500/40">
                ...
                <div className="text-4xl font-black text-red-400 mt-1 uppercase font-mono">
          ...
          <div className="flex items-center justify-between border-t border-red-500/50 pt-6 font-mono text-sm">
            <span className="text-red-300">
              Auto-reverting to Wall Dashboard in {criticalTakeover.timeoutSeconds}s
            </span>
            <button
              onClick={() => setCriticalTakeover(null)}
              className="px-6 py-2 rounded-xl bg-white text-red-950 font-black text-sm uppercase hover:bg-slate-200 transition-colors"
            >
              Dismiss Alarm
            </button>
          </div>
      ...
      {/* TOP HEADER */}
      <header className="h-16 border-b border-slate-800/90 px-6 flex items-center justify-between bg-[#080d17] sticky top-0 z-30">
        {/* Brand */}
        <div className="flex items-center gap-4">
          <img
          ...
          <div className="border-l border-slate-800 pl-3">
            <div className="flex items-center gap-2">
              <h1 className="text-base font-black tracking-wide text-white">KREA IT OPERATIONS</h1>
        ...
        <div className="flex items-center gap-1 bg-slate-950 p-1 rounded-xl border border-slate-800">
          {pages.map((p, idx) => (
            <button
              ...
              className={`px-3.5 py-1.5 rounded-lg text-xs font-black tracking-wider transition-all uppercase ${
          ...
          <button
            ...
            className="p-1.5 px-2 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-slate-900 flex items-center gap-1 text-[11px] font-mono"
          >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-right border-l border-slate-800 pl-4">
            <div className="font-mono text-xl font-black text-slate-100 tracking-wider">
              {timeStr}
            </div>
            <div className="text-[10px] text-slate-400 font-medium font-mono">{dateStr} IST</div>
          </div>
        </div>
      </header>
        ...
        {currentPageIndex === 0 && (
          <div className="h-full flex flex-col justify-between space-y-4">
            ...
            <div className="grid grid-cols-12 gap-4 flex-1 min-h-0">
              <div className="col-span-8 noc-card p-4 rounded-xl flex flex-col justify-between border-slate-800 bg-[#0a101d]">
              ...
              <div className="col-span-4 noc-card p-4 rounded-xl flex flex-col justify-between border-slate-800 bg-[#0a101d]">
                <div>
        ...
        {currentPageIndex === 3 && (
          <div className="h-full flex flex-col justify-between space-y-3">
            ...
            <div className="grid grid-cols-12 gap-3 flex-1 min-h-0">
              ...
              <div className="col-span-4 noc-card p-4 rounded-xl border-slate-800 flex flex-col justify-between bg-[#0a101d]">
                <div>
              ...
              <div className="col-span-8 noc-card p-4 rounded-xl border-slate-800 flex flex-col justify-between bg-[#0a101d]">
                <div>
